import { Alert, Button, DatePicker, Form, Input, message, Progress, Select, Spin, Table, TimePicker } from 'antd'
import Icon, { AppleFilled, LoadingOutlined, LogoutOutlined, PieChartFilled, UserOutlined } from '@ant-design/icons'
import { useState } from 'react'
import { PaginationSortingFilter } from './components/PaginationSortingFilter'
import { CustomSelectionOptions } from './components/CustomSelectionOptions'
  ...
  return (
    <div className='App'>
        <header style={{display: "flex", gap: "8px", flexDirection: "column"}}>
          ...
          <div className='Form'>
            {showAlert && <Alert message="Form submitted successfully" type="success" showIcon closable />}
        ...
        <div className='Pagination-Sorting-Filter'>
          <PaginationSortingFilter />
        </div>

        <div className='CustomSelectionOptions'>
